...
export default class workspaceLayers {
  constructor(layer_container) {
    ...
    this.workspace = document.querySelector(".js-workspace");
  ...
  /*
    Initialize the layers in the main js file like as the code below:
      import workspaceLayers from './path'
      const workspaceLayers = new Layers(document.querySelector(".js-workspace__layers"));
      workspaceLayers.init();
    */
}
